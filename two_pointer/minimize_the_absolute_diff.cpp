...
int solve(vector<int> &A, vector<int> &B, vector<int> &C) {
    ...
    while(i!=0 && j!=0 && k!=0)
    {
        ...
        int curr_max=max(A[i],max(B[j],C[k]));
        ...
        else if(B[j]==curr_max)
        {
            
                j--;
        }
        else if(C[k]==curr_max)
        {
